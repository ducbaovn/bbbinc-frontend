		...
		draw : function(){
			...
			if (this.display){
				...
				each(this.xLabels,function(label,index){
					...
					if(index % this.xLabelsSkipper === 0) {							ctx.beginPath();
						//X axis ticks only painted for number of selected x values							ctx.moveTo(linePos,this.endPoint);
						ctx.beginPath();							ctx.lineTo(linePos,this.endPoint + 5);
						ctx.moveTo(linePos,this.endPoint);							ctx.stroke();
						ctx.lineTo(linePos,this.endPoint + 5);							ctx.closePath();
						ctx.stroke();		
						ctx.closePath();		
					}
		...
		getPointsAtEvent : function(e){
			...
			helpers.each(this.datasets,function(dataset){
				helpers.each(dataset.points,function(point){
					point.fillColor = dataset.strokeColor;
					point.strokeColor = dataset.strokeColor;
